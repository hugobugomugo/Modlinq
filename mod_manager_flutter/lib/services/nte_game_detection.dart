...
class NteGameDetection {
  ...
  static List<String> windowsSteamRoots() => SteamLibraries.windowsInstallRoots();

  /// Steam's own install path, as Steam records it for the current user.
  static String? steamPathFromRegistry() => SteamLibraries.steamPathFromRegistry();
  ...
  static String? vdfValue(String line, String key) =>
      SteamLibraries.vdfValue(line, key);

  static List<String> _steamRoots() => SteamLibraries.installRoots();
  ...
  static List<String> steamLibraryRootsFrom(Iterable<String> steamRoots) =>
      SteamLibraries.libraryRoots(steamRoots: steamRoots);

  /// All `steamapps/common` directories across every Steam library.
  static List<String> steamLibraryCommons() => SteamLibraries.commons();

  /// Same, for an explicit set of Steam installs.
  static List<String> steamLibraryCommonsFrom(Iterable<String> steamRoots) =>
      SteamLibraries.commons(steamRoots: steamRoots);

  /// All `steamapps/compatdata/<id>/pfx` Proton prefixes.
  static List<String> steamProtonPrefixes() => SteamLibraries.protonPrefixes();
  ...
  static String? findSteamAppId(String steamappsPath, String installDir) =>
      SteamLibraries.findAppId(steamappsPath, installDir);
